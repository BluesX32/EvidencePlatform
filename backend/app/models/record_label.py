"""SQLAlchemy model for record_labels (label assignments, migration 013)."""
...
class RecordLabel(Base):
    """Assignment of a ProjectLabel to a record or overlap cluster."""
    ...
    # Exactly one of record_id / cluster_id must be non-null.
